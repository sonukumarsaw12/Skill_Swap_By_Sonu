            ...
            <div className="relative w-full max-w-md z-10">
                <div className="bg-white/10 dark:bg-black/50 backdrop-blur-md rounded-[2.5rem] shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] border border-white/40 dark:border-white/20 p-6 md:p-10 relative overflow-hidden ring-1 ring-white/10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Sign in to continue your journey</p>
                    </div>
                    ...
                    <div className="mt-6 flex justify-center">
                        <Link href="/admin/login" className="flex items-center gap-2 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
